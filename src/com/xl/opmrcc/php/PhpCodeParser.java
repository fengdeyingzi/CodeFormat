...
public class PhpCodeParser implements Runnable{
	...
	private ArrayList<PhpCodeSpan> mCodeSpans=new ArrayList<PhpCodeSpan>();
	...
	public ArrayList<PhpCodeSpan> getCodeSpans() {
		return mCodeSpans;
	}
			...
			for(int index=0;index<code.length;){
				...
				case '#':
					...
					if(keyPos>=0){
						...
						tempIndex=indexFind;
						mCodeSpans.add(new PhpCodeSpan(PhpCodeSpan.TYPE_PRO_KEY_WORDS, index, tempIndex,code));
						index=tempIndex;
	...
	public String toString() {
		Iterator<PhpCodeSpan> iterator = mCodeSpans.iterator();
